    ...
    <div className="card z-[47] w-full relative">
      ...
      >
        ...
        <div className="flex w-full flex-col gap-8">
          <h3 className="text-lg flex items-start text-text_dark_1 flex-col gap-4 justify-between font-portfolio_bold">
            <span
              data-scroll
              data-scroll-speed="2"
            ...
            <span
              data-scroll
              data-scroll-speed="2"
              className="text-[12px] flex font-portfolio_bold1 items-center justify-between w-full"
            >
              Development
