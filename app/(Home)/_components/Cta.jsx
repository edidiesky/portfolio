...
export default function Cta() {
  ...
  const ctatext4 =
    "I AM EDDIIONG ESSIEN AND I AM A SELF-LEARNED SOFTWARE DEVELOPER, DEDICATED IN CREATING APPEALING USE-INTERFACES SINCE 2021";
  const ctatext1 =
  ...
  return (
    <div data-scroll className="py-20 z-50">
      <div className="w-full md:w-[500px] mx-auto px-8 m-auto max-w-custom grid grid-cols-1 sm:grid-cols-custom_3 gap-4 ">
        <div className="w-full">
          <h3 className="text-xl font-portfolio_bold1 text-text_dark_1">
            01 /
          </h3>
        </div>
        <div className="w-full flex flex-col gap-16">
          <h4
            ref={ctaText_4}
            className=" w-full md:w-[95%] text-lg flex flex-wrap gap-x-[7px] gap-y-[12px]  leading-[1] font-portfolio_bold1 text-text_dark_1 "
          >
          ...
          <h4
            ref={ctaText_2}
            className="about_text1 w-full md:w-[95%] text-xl leading-[1.2] font-portfolio_bold1 text-text_dark_1 "
          >
            {ctaText2.split(" ").map((x, index) => {
              return (
                <span
                  key={index}
                  className="inline-flex hide relative mr-2 text-center mt-2"
                >
                  <motion.span
                    variants={slideup}
                    custom={index}
          ...
          <div className="w-full lg:w-[100%] grid-cols-1 grid py-5 gap-12 sm:grid-cols-custom_2">
            ...
            <div ref={ctaText_3} className="w-full flex flex-col gap-4">
              <h5 className="about_text1 w-full text-[14px] leading-[1.6] font-normal text-text_dark_1 font-portfolio_semibold">
                A blend of Product Engineering and Electrical engineering.
              </h5>
              <h4 className=" w-full text-[14px] flex flex-wrap gap-x-[7px] gap-y-[8px]  items-start leading-[1] font-normal font-portfolio_semibold text-text_dark_1 ">
                {/* ctatext3 */}
